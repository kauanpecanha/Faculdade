...
\autor{Aqui vai o nome do autor do TCC}
\newcommand{\entradaAutor}{ULTIMOSOBRENOME, Nomes} % Sem ponto no final

% Titulo do trabalho
\titulo{Aqui vai o título do trabalho} %Título do trabalho
\newcommand{\englishTitle}{Aqui vai o título do trabalho em inglês} %Título do trabalho em inglês
